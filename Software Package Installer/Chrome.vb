...
Public Class Chrome
    ...
    Private Sub Chrome_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_94f54ae29b8547ac9ad56f81e55d294b.zip"), Texbbb.TextBox5.Text)
